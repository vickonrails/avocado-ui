...
> avocado-ui is an experimental design system for side projects. It's an experiment focused on building a themeable, accessible and modern design system in React.

## Why 🥑 avocado-ui

There's a lot of wondeful design systems out there, so why make another?

I'm building `avocado-ui` to increase my knowledge of design systems. The argument is that building a design system from scratch will help me learn morer about design systems. I don't expect people to use it, but you can learn a thing or two by diving into the [source code](https://github.com/vickOnRails/avocado-ui).
